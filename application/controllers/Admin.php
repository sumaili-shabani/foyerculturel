   ...
   */
	...
	*/
    ...
    function fetch_video(){  
         ...
         {  
              $sub_array = array();  
              $sub_array[] = '<img src="'.base_url().'upload/video/'.$row->image.'" class="img-thumbnail user-avatar bg-dark  d-sm-flex" width="50" height="35" />';  
              $sub_array[] = nl2br(substr($row->nom, 0,20)).'...';  
              ...
              $sub_array[] = '<button type="button" name="update" idv="'.$row->idv.'" class="btn btn-dark btn-sm btn-circle update"><i class="fa fa-edit"></i></button>'; 
