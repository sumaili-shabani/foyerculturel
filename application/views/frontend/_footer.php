...
<section class="footer-wrapper clearfix" style="background-color: rgb(253, 253, 79);">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="widget text-widget">
                    <div class="widget-title" style="color: rgb(171, 1, 1);">
                        <h2 style="color: rgb(171, 1, 1);">Apropos de nous</h2>
                    </div>
                  
                    <p style="color:rgb(15, 6, 1);">  <img class="img-responsive" src="<?= $icone_info ?>" alt="logo" style="height: 100px; float: left; padding-right: 10px;"/><span class="fbt-tooltip text-justify" data-toggle="tooltip" title="Blog pour information"></span> <?php echo(substr($blog_info, 0,350)) ?>...</p>
                    <!-- Social Icons Start -->
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="widget categories-widget">
                    <div class="widget-title">
                        <h2 style="color: rgb(171, 1, 1);">Nos Catégories</h2>
                    </div>
                        ...
                        if ($categories2->num_rows() <=0) {
                            ...
                            foreach ($categories2->result_array() as $memu_autre) {
                                ...
                                ?>
                                 ...
                                 <li style="color:rgb(15, 6, 1);"><a href="<?php echo(base_url()) ?>home/publication/<?php echo($memu_autre['idcat']) ?>" style="color:rgb(15, 6, 1);"><?php echo(substr($memu_autre['nom'], 0,20)) ?>  <span><?php echo($nombre_pub) ?></span></a></li>
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="widget fbt-vc-inner clearfix">
                    <div class="widget-title">
                        <h2 style="color: rgb(171, 1, 1);">Nos articles</h2>
                    </div>
                                        ...
                                        <div class="col-sm-8 col-xs-9 no-padding-left">
                                            <div class="post-content">
                                                <a href="<?php echo(base_url())?>home/article/<?php echo($row['idart'])?>">
                                                    <h3 style="color:rgb(15, 6, 1);"><?php echo (substr($row['nom'], 0,80)); ?> ...</h3>
                                                </a>
                                                <div class="post-info clearfix" style="color:rgb(15, 6, 1);">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="widget flickr-widget clearfix">
                    <div class="widget-title">
                        <h2 style="color: rgb(171, 1, 1);">Flickr Photos</h2>
                    </div>
        ...
        <div class="copyrights">
            <div class="row">
                <div class="col-md-6">
                    <p style="color:rgb(15, 6, 1);">COPYRIGHT &copy; <?php date('Y') ?> Dream of drc</p>
                </div>
                <div class="col-md-6">
                    <div class="fbt-footer-nav">
                        <ul>
                            <li><a href="<?php echo(base_url()) ?>" style="color:rgb(15, 6, 1);">Home</a></li>
                            
                            <li><a href="<?php echo(base_url()) ?>home/about" style="color:rgb(15, 6, 1);">Apropos</a></li>
                            <li><a href="<?php echo(base_url()) ?>home/contact" style="color:rgb(15, 6, 1);">Contact</a></li>
                        </ul>
                    </div>
                </div>
            </div>
