                                    ...
                                    <div class="form-group col-md-12" style="margin-top: 10px;">
                                      <div class="row">
                                        ...
                                        <div class="col-md-8">
                                           ...
                                           <button type="button" name="delete" id="delete" class="btn btn-outline-dark " id="add_button" data-toggle="modal" data-target="#userModal"> <i class="fa fa-plus fa-lg"></i> &nbsp; Effectuer l'opération</button>
